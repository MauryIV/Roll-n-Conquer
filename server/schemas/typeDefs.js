const typeDefs = `
  ...
  type Mutation {
    ...
    addFriend(username: String!, wins: Int, losses: Int, ties: Int, streak: Int, daily: Int): User
    recordStats(username: String!, wins: Int, losses: Int, ties: Int, streak: Int, daily: Int): User
